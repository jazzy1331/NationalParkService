		...
		if (error) {
			...
			if (items.length > 0) {
				...
				if (topic == "newsreleases") {
					...
					// Beautifies the date
					if(correctItem.releasedate.length > 0){
						var month = correctItem.releasedate.substring(5,7);
						var day = correctItem.releasedate.substring(8,10);
						var year = correctItem.releasedate.substring(0,4);
						...
						correctItem.releasedate = month + " " + day + ", " + year;
					}
