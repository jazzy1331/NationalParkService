...
class FillInformation extends React.Component {
  ...
  render() {
    ...
    if (error) {
      ...
      return <div>{topic} information is currently not available. Please try again later.</div>;
    } else if (!isLoaded) {
      return <div>Loading {topic} List...</div>;
    } else {
                     ...
                     <div class="card mb-3">
                           <div class="card-body">
                              ...
                              {correctItem.subject.length > 0 ?
                                <p><strong>Subject(s): </strong>{correctItem.subject}</p> : <p><strong>Subject(s): </strong>Not Available</p>
                              }
                              {correctItem.commoncore.statestandards.length > 0 ?
                                <p><strong>State Standards: </strong>{correctItem.commoncore.statestandards}</p> : <p><strong>State Standards: </strong>None</p>
                              }
                              {correctItem.commoncore.mathstandards.length > 0 ?
                                <p><strong>Math Standards: </strong>{correctItem.commoncore.mathstandards}</p> : <p><strong>Math Standards: </strong>None</p>
                              }
                              {correctItem.commoncore.elastandards.length > 0 ?
                                <p><strong>ELA Standards: </strong>{correctItem.commoncore.elastandards}</p>: <p><strong>ELA Standards: </strong>None</p>
                              }
                              ...
                              {correctItem.gradelevel.length > 0 ?
                                <p><strong>Grade Level: </strong>{correctItem.gradelevel}</p> : <p><strong>Grade Level: </strong>Mot Available</p>
                              }
                              {correctItem.duration.length > 0 ?
                                <p><strong>Duration: </strong>{correctItem.duration}</p> : <p><strong>Duration: </strong>Not Available</p>
                              }
                           </div>
                 ...
                 <div class="card-deck d-flex justify-content-center">
                     <div class="card mb-3">
                           <div class="card-body">
                             ...
                             {freq.length > 0 && <p><strong>Frequency:</strong> {freq}</p>}
                             {correctItem.recurrencedatestart.length > 0 && <p><strong>Start Date: </strong>{correctItem.recurrencedatestart}</p>}
                             {correctItem.recurrencedateend.length > 0 && <p><strong>End Date: </strong>{correctItem.recurrencedateend}</p>}
                     ...
                     <div class="card mb-3">
                           <div class="card-body">
                              ...
                              {correctItem.contactemailaddress.length > 0 &&
                                ...
                                <a href={"mailto:" + correctItem.contactemailaddress}>{correctItem.contactemailaddress}</a></p>}
