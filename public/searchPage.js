        ...
        if(this.props.target == "parks"){
          ...
          return(
            <div class="card">
                <div class="card-header" id="headingOne">
                  <h2 class="mb-0">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" onClick={() => this.changeIcon(this.props.target)} data-target="#collapseParks" aria-expanded="true" aria-controls="collapseOne">
          ...
          return(
            <div class="card">
                <div class="card-header" id="headingOne">
                  <h2 class="mb-0">
                    <button class="btn btn-link collapsed" onClick={() => this.changeIcon(this.props.target)} type="button" data-toggle="collapse" data-target={"#collapse" + this.props.target} aria-expanded="true" aria-controls="collapseOne">
                      <p>{this.props.targetReadable} <span id={this.props.target} class="fas fa-chevron-right"></span></p>
